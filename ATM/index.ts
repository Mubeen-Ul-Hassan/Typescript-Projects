...
const text: string =
  chalk.bgGreen(" WARNING: ") +
  chalk.dim(
    " A dummy account is created and it's pin is available in the code. Initial balance is hardcoded as PKR 10,000 but will change as you withdraw or paybills."
  ) +
  "\n\n" +
